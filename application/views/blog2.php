        ...
        <div class="row">
          <div class="col-md-12 post-content" data-aos="fade-up">
            ...
            <div class="single-post">
             <img class="blogimg" src="<?php echo base_url(); ?>assets/img/blog/Hybrid.jpg" alt="">
              <h2>Hybrid Learning Bisa jadi Trend Pelatihan 2023</h2>
                <p>
                Pelatihan merupakan program yang penting bagi perkembangan skill yang dimiliki oleh karyawan untuk meningkatkan kinerja perusahaan. Pasca pandemi banyak perubahaan yang dialami oleh perusahaan, yaitu salah satunya dengan bekerja secara hybrid. Ternyata, di dunia leaning ada juga lho yang namanya hybrid learning, yang bisa jadi salah satu pilihan learning bagi karyawan. Apa itu hybrid learning?
                </p>
              <h2>Hybrid Learning</h2>
              <p>Merupakan metodologi pembelajaran di mana pembelajaran di kelas (classroom) dan pelatihan online (online learning) digabungkan dengan cara yang memungkinkan pengalaman belajar terbaik serta peningkatan kinerja karyawan. Ini membantu karyawan melakukan pelatihan terlepas dari lokasi dan tidak dibatasi oleh waktu dan ketersediaan pelatih.</p>
              <p>Konsep pelatihan menggunakan Hybrid Learning menurut <a color="#ef3c2d" href="https://elearningindustry.com/elearning-authors/suresh-kumar-dn-2">Suresh Kumar DN</a> seorang pengusaha di industri elearning menyampaikan konsep hybrid learning meliput hal berikut ini :</p>
              <ul>
                <li>Berikan pelajaran sinkron menggunakan Zoom, MS Teams, Google Meet, dan alat lainnya</li>
                <li>Memaksimalkan waktu belajar peserta didik</li>
                <li>Meningkatkan kerjasama dengan pembelajaran sosial</li>
                <li>Gabungkan ruang kelas, pelatihan virtual, dan eLearning</li>
                <li>Peserta didik dapat berinteraksi dengan konten dengan cara yang bermakna</li>
                <li>Pelajar dapat mengakses praktik perbaikan yang ditargetkan, praktik terpandu, dan chatbots</li>
                <li>Saat memberikan pembelajaran, pembelajaran harus mudah diakses dan dijalankan di perangkat apa pun.</li>
              </ul>
              <p>Saat memberikan pelatihan, pelatihan harus mudah diakses dan dijalankan di perangkat apa pun.Dan juga mempertimbangkan hal ini:</p>
              <ul>
                <li>Merancang konten perlu adanya pengiriman yang instant yaitu melalui seluler sehingga konten pelatihan dapat diakses di mana saja, kapan saja. </li>
                <li>Pembelajaran bite-size atau seukuran gigitan paling cocok untuk pengiriman yang mengutamakan seluler.</li>
                <li>Yang penting, pelatih harus bisa membuat kursus dengan cepat</li>
            
              </ul>
              <p>Ini adalah metodologi pelatihan yang ideal untuk sekarang dan berlanjut di masa depan untuk karyawan, walaupun tidak menggunakan meja kerja.</p>


              <span>Sumber:  <a style="color:blue" href="https://elearningindustry.com/how-to-design-an-effective-hybrid-learning-program">https://elearningindustry.com/how-to-design-an-effective-hybrid-learning-program</a></span>
