      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="psection-title">
            <h3 style="font-size:25px; margin-top:30px"><b>Optimalkan Materi Pelatihan Karyawan, Mitra & Pelanggan <br> Kamu dengan Video Talent</b></h3>
          </div> 
          <img style="width:60%;" class="center" src="<?php echo base_url(); ?>assets/img/product/VideoShooting.png" alt="">
          <h5 style="text-align:center; margin-top:40px">Video shooting menggunakan gaya hibrida yaitu menggabungkan rekaman video nyata dan gerakan grafis. Dimana fungsi grafis
             sebagai alat komunikasi yang kuat untuk menarik perhatian, emosi dalam penyampaian informasi. </h5>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div style="margin-top:90px; margin-bottom:80px" class="row">
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img style="width:100%" src="<?php echo base_url(); ?>assets/img/product/VideoShooting.png" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left;" data-aos-delay="100">
            <h3 style="text-align:left; margin-top:40px; padding-bottom:10px"><b> Optimalkan Materi Pelatihan Karyawan, Mitra & Pelanggan Kamu dengan Video Talent</b></h3>
            <p style="text-align:left;">
            <h5 style="text-align:justify; margin-top:0px">Video shooting menggunakan gaya hibrida yaitu menggabungkan rekaman video nyata dan gerakan grafis. Dimana fungsi grafis
             sebagai alat komunikasi yang kuat untuk menarik perhatian, emosi dalam penyampaian informasi. </h5>
            </p>
          </div>
        </div>
  ...
  <section class="animasi2">
      <div class="container">
        <div class="row d-flex justify-content-center mt-100 mb-100">
            <h3 style="margin-bottom:20px"><b> Kenapa Video Shooting Cocok Untuk Program Training Kamu?</b></h3>
                               ...
                               <ul class="list-style-none">
                                   <li class="d-flex no-block card-body">
                                       ...
                                       <div style="margin-top:3px">
                                           <a style="color:#5e5e5e" class="m-b-0 font-medium p-0" data-abc="true">Talent mengkomunikasikan pelatihan dengan gaya mengajar</a>
                                   ...
                                   <li class="d-flex no-block card-body ">
                                       ...
                                       <div style="margin-top:3px">
                                           <a style="color:#5e5e5e" class="m-b-0 font-medium p-0" data-abc="true">Mengilustrasikan pesan dalam bentuk ilustrasi grafis</a>
                                   ...
                                   <li class="d-flex no-block card-body ">
                                       <i class=""><img style="width:60px" src="<?php echo base_url(); ?>assets/img/product/check.png" alt=""></i>
                                       <div style="margin-top:3px">
                                           <a style="color:#5e5e5e" class="m-b-0 font-medium p-0" data-abc="true">Menyesuaikan gaya belajar pengguna (audio, visual)</a>
                                   ...
                                   <li class="d-flex no-block card-body ">
                                       <i class=""><img style="width:60px" src="<?php echo base_url(); ?>assets/img/product/check.png" alt=""></i>
                                       <div style="margin-top:3px">
                                           <a style="color:#5e5e5e" class="m-b-0 font-medium p-0" data-abc="true">Dapat digunakan pada pelatihan daring dan luring</a>
    ...
    <section class="playlist">
      <div class="row">
      <div class="psection-title">
          <p style="font-weight: 600; margin-top:80px">
            <h3 style="font-size:25x; "><b> Demo Video Shooting </b> </h3>
          </p>
          <!-- <p style="text-align:center; font-size:18px">
              Video shooting menggunakan gaya hibrida yaitu menggabungkan rekaman video nyata dan gerakan grafis. <br>
              Dimana fungsi grafis sebagai alat komunikasi yang kuat untuk menarik perhatian, emosi dalam penyampaian informasi.
          </p> -->
        </div> 
        ...
        <div class="container">
            ...
            <div class="main-video-container">
              <video src="<?php echo base_url(); ?>assets/video/shooting-01.mp4" poster="<?php echo base_url(); ?>assets/img/product/thumbnail/vshooting-lecture.jpg" loop controls class="main-video" ></video>
              <h3 class="main-vid-title">Video Shooting - Lecturing Concept - Hasnul Suhaimi</h3>
            </div>

            <div class="video-list-container">

              <div class="list active">
                  <video src="<?php echo base_url(); ?>assets/video/shooting-02.mp4" class="list-video" poster="<?php echo base_url(); ?>assets/img/product/thumbnail/vshooting-lecture.jpg"></video>
                  <h3 class="list-title">Video Shooting - Lecturing Concept - Hasnul Suhaimi</h3>
              </div>

              <div class="list">
                  <video src="<?php echo base_url(); ?>assets/video/shooting-03.m4v" poster="<?php echo base_url(); ?>assets/img/product/thumbnail/vshooting-scenario.jpg" class="list-video"></video>
                  <h3 class="list-title">Video Shooting -Scenario Concept - Tokopedia Univ</h3>
              </div>
    ...
    <section class="animasi2">
      <div class="container">
        <div class="row d-flex justify-content-center mt-100 mb-100">
            <h3> <b> Alur Pengerjaan Video Shooting </b></h3>
                           ...
                           <div class="card">
                               <ul class="list-style-none">
                                   ...
                                   <li class="d-flex no-block card-body ">
                                       ...
                                       <div style="margin-top:10px">
                                           <a class="m-b-0 font-medium p-0" data-abc="true">Reading Script</a>
                                           <span class="">Proses sebelum produksi membahas materi bersama talent </span>
                                       </div>
                                       
                                   </li>
                                   <li class="d-flex no-block card-body">
                                       <i class=""><img style="width:75px" src="<?php echo base_url(); ?>assets/img/product/check/c5.png" alt=""></i>
                                       <div style="margin-top:10px">
                                           <a class="m-b-0 font-medium p-0" data-abc="true">Shooting</a>
                                           <span class="">Proses syuting dilaksanakan berdasarkan jadwal yang sudah ditentukan bersama</span>
                                       </div>
                                       
                                   </li>
                                   <li class="d-flex no-block card-body ">
                                       <i class=""><img style="width:75px" src="<?php echo base_url(); ?>assets/img/product/check/c6.png" alt=""></i>
                                       <div style="margin-top:10px">
    ...
    <!-- <div class="rowfoot">
      <div class="column-footer">
        <img src="<?php echo base_url(); ?>assets/img/product/pooter.png"  width="43%" alt="">
      </div>
      <div class="column-footer">
       <img src="<?php echo base_url(); ?>assets/img/product/pooter2.png"  width="40%" alt="">
      </div>
    </div> -->
