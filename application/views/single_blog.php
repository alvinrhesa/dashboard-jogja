        ...
        <div class="row">
          <div class="col-md-12 post-content" data-aos="fade-up">
            ...
            <div class="single-post">
              <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/blog/vexplainer.jpg" alt="">
              <h2>Apa itu Video Explainer?</h2>
            
                <p>
                Video singkat menjadi populer akhir-akhir ini, semenjak terlahirnya aplikasi sosial media yang menyediakan video-video singkat. Sama halnya, Video Explainer seperti namanya, tidak lain adalah video pendek yang menyampaikan konsep atau pesan tertentu. 
                </p>
              <h2>Pengertian Video Explainer</h2>
              <p>Video Explainer merupakan video singkat berupa animasi atau live shot yang memiliki fungsi untuk menjelaskan konsep atau berbagi pesan. Biasanya video singkat yang digunakan orang untuk memperkenalkan ide, menjelaskan konsep, dan menceritakan bagaimana ide tersebut membantu memecahkan suatu permasalah pelanggan. Ini adalah cara untuk membuat kesan menarik dan juga memberikan informasi yang cukup sehingga audiens dapat menghubungkannya dengan kebutuhan mereka. </p>
              <h2>Keuntungan menggunakan video explainer</h2>
              <ol>
                <li><b> Peningkatan Keterlibatan Pengguna</b>
                  <p>Video Explainer adalah yang terbaik untuk menarik perhatian penonton. Mereka menarik audiovisual penonton, yang merupakan indra yang paling umum. Dengan demikian, penggunaan video penjelasan adalah strategi yang sangat efektif dalam kursus eLearning. Penonton dapat langsung terlibat dengan konten dan terlibat dalam pembelajaran. Video juga bagus untuk menyimpan informasi.</p>
                </li>
                <li> <b> Peningkatan Nilai Merek</b>
                  <p>Video explainer membangun kesan. Video-video ini dapat melakukan keajaiban dalam membangun nilai merek dan menciptakan kesan yang memorable di benak audience. Orang-orang melupakan teksnya tetapi mengingat elemen audiovisual dengan lebih baik. Sifat dinamis video menciptakan kesan yang lebih baik di benak audiens sehingga meningkatkan nilai merek.</p>
                </li>
                <li> <b> Peningkatan Retensi </b>
                  <p>Video explainer lebih menarik daripada modul eLearning biasa. Karena lebih pendek dan berisi. Sifat singkat dan tajam, membantu retensi pengetahuan. Itu tidak membebani memori dan membantu memecah konten menjadi potongan-potongan kecil. Ini memanfaatkan waktu dengan baik dan meningkatkan transfer pengetahuan.</p>
                </li>
                <li> <b> Peningkatan Pengembalian Investasi</b>
                  <p>Video explainer lebih mahal untuk dibuat. Namun, dalam jangka panjang, video explainer memberikan lebih banyak Return On Investment karena lebih efektif dalam menyampaikan pesan dan membekas di benak audiences.</p>
                </li>

              </ol>
              <h2>Summary</h2>
              <p>Video Explainer memiliki banyak manfaat. Namun, Anda dapat menuai keuntungan hanya jika video dibuat dengan benar dan efektif. Untuk mengetahui tips membuat video explainer yang berkualitas, bisa cek di sosial media kita </p>

              <span>Sumber:  <a style="color:blue" href="https://elearningindustry.com/explainer-videos-embrace-the-power-of-short-and-sweet">https://elearningindustry.com/explainer-videos-embrace-the-power-of-short-and-sweet</a></span>
