  ...
  <!-- <section id="" class="product section">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="psection-title">
            <p style="font-size:25px; margin-top:45px; font-weight:400">
                <b><span style="color:#ef3c2d">Era Baru Pembelajaran: </span> <span>Video Podcast untuk Pelatihan</span></b>

            </p>
          </div> 
          <img style="width:55%;" class="center" src="<?php echo base_url(); ?>assets/img/product/VideoPodcast-01.png" alt="">
          <span style="text-align:center; font-size:20px"> Video Podcast adalah satu kekuatan besar dalam podcasting yang sangat menarik. Video Podcast dapat didengarkan, ditonton, dan memungkinkan pembelajar belajar kapan saja, dimana saja, dan dengan perangkat apa saja.</span>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div style="margin-top:90px; margin-bottom:80px" class="row">
         <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left;" data-aos-delay="100">
          <div class="psection-title">
            <p style="font-size:25px; text-align:justify; margin-top:45px; font-weight:400">
                <b><span style="color:#ef3c2d">Era Baru Pembelajaran: </span> <span>Video Podcast untuk Pelatihan</span></b>

            </p>
          </div> 
            <p style="text-align:left; margin-top: 40px">
            <span style="text-align:justify; font-size:20px; "> Video Podcast adalah satu kekuatan besar dalam podcasting yang sangat menarik. Video Podcast dapat didengarkan, ditonton, dan memungkinkan pembelajar belajar kapan saja, dimana saja, dan dengan perangkat apa saja.</span>
            </h5>
            </p>
          </div>
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img style="width:100%" src="<?php echo base_url(); ?>assets/img/product/VideoPodcast-01.png" class="img-fluid" alt="">
          </div>
    ...
    <!-- <section class="playlist">
      ...
      <div class="psection-title">
          <p style="font-weight: 400">
            <b><h3 style="font-size:25x">Demo Video Podcast</h3></b>
          </p>
        ...
        <div class="container">
            ...
            <div style="text-align:center" class="">
              <video style="width:60%" src="<?php echo base_url(); ?>assets/video/shooting-01.mp4" poster="<?php echo base_url(); ?>assets/img/product/thumbnail/vpodcast.jpg" loop controls class="main-video" ></video>
    ...
    <section class="playlist">
      ...
      <div class="psection-title">
          <p style="font-weight: 600">
            <h3 style="font-size:25x;margin-top:80px"> <b> Demo Video Podcast</b></h3>
          </p>
        </div> 
    ...
    <section id="skillsh" class="skillsh">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="">
            <img style="width:90%" src="<?php echo base_url(); ?>assets/img/baru/Podcast-01.png" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content " data-aos="fade-left; margin-top:20px" data-aos-delay="100">
            <h2 style="font-size:25px; margin-top:50px; padding-bottom:10px;">Manfaat Podcast Untuk Training</h2>
            <p style="">
                <ol style="font-size:20px; line-height:60px">
                    <li>Fleksibel didengarkan dan ditonton</li>
                    <li>Bias informasi</li>
                    <li>Lebih Menarik</li>
                    <li>Menstimulasi otak dan mood</li>
                    <li>Podcast cocok untuk gen millennial</li>
                </ol>
            </p>
    ...
    <section class="animasi2">
      <div class="container">
        <div class="row d-flex justify-content-center mt-100 mb-100">
            <h3> <b> Alur Pengerjaan Video Podcast </b></h3>
